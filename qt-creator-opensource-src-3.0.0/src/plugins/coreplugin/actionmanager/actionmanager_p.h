...
public:
    typedef QHash<Core::Id, CommandPrivate *> IdCmdMap; //Id与Command映射表
    typedef QHash<Core::Id, ActionContainerPrivate *> IdContainerMap; //id与ActionContainer映射表
...
public:
    IdCmdMap m_idCmdMap; //所有系统内部的 id与Command对象映射表

    IdContainerMap m_idContainerMap; //管理器持有的菜单集合 ActionContainer集合
